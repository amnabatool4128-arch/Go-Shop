      ...
      <nav className="max-w-[1400px] md:px-12 px-2 md:py-10 py-2 mx-auto flex items-center sm:flex-row flex-col justify-between h-[14vh] gap-2">
        <div className="flex items-center  gap-1">
          ...
          <a
            ...
            className="flex w-8 h-8 sm:w-12 sm:h-12 bg-zinc-100 rounded-full p-1 "
          >
            <img
              src={Logo}
              alt="logo"
        ...
        {/* Nav Action */}
        <div className="flex items-center gap-x-5 sm:gap-x ">
          {/* Search Box */}
          <div className="flex p-1 rounded-full px-1 py-1 border-2 border-blue-600">
            <input
              type="text"
              name="search"
              id="search"
              placeholder=" Search..."
              autoComplete="off"
              className="lg:h-[5vh] lg:pl-4 flex-1 sm:h-[2.5vh] bg-transparent focus:outline-none"
